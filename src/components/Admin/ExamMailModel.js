...
export default class ExamMailModel extends Component {
  ...
  componentWillMount() {
    ...
    if (this.props.shortListedCandidates) {
      this.setState({
        shortListedCandidates: this.props.shortListedCandidates,
      });
    }
  }
  ...
  sendExamLink = (data) => {
    ...
    formData.append(
      "candidateEmails",
      _.map(this.state.shortListedCandidates, (s) => s.id)
    );
    axios
  ...
  importSampleFile = () => {
    ...
    switch (this.props.modalSection.type) {
      ...
      case "Question":
        ...
        line =
          "1," +
          this.state.csvImportObject.section +
          "," +
          this.state.csvImportObject.questionType +
          "," +
          this.state.csvImportObject.examType;
        str += line + "\r\n";
        ...
        return (
          ...
          >
            ...
            <div>
              ...
              <strong
                className="ml-2"
                style={{ color: "#3b489e", marginLeft: "1rem" }}
              >
        ...
        >
          ...
          >
            ...
            >
              ...
              {this.props.modalSection?.type === "Email" ? (
                <h5 className="setting-title" style={{ marginRight: "5rem" }}>
