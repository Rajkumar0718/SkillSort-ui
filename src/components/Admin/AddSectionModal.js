                    ...
                    <div className="modal-content" style={{ borderStyle: 'solid', borderColor: '#af80ecd1', borderRadius: "32px" }}>
                        <div className="modal-header" style={{ padding: "2rem 2rem 0 3.85rem", border: "none" }}>
                            ...
                            {this.props.modalSection.action === 'Update' ?
                                <button type="button" onClick={this.props.onCloseModal} className="close" style={{border:'none'}} data-dismiss="modal">&times;</button> :
                                <button type="button" onClick={this.props.onCloseModalAdd} className="close" style={{border:'none'}} data-dismiss="modal">&times;</button>}
                        </div>
                        <div className="modal-body" style={{ paddingTop: "5px" }}>
                            <form onSubmit={this.handleSubmitAddSection}>
                                <div>
                                    <label for="question"  className="model-label">{this.state.forGroupType?'GroupType':'Section'}<span className='required'></span></label>
                                ...
                                <div style={{marginTop:'20px'}}>
                                    <label for="question" className='model-label'>Description<span className='required'></span></label>
                                ...
                                <div className="form-group row">
                                    <div className="col-md-11">
                                        <button disabled={this.state.disabled} type="submit" style={{ float: "right" , marginTop:'15px' }} className="btn btn-sm btn-nxt">{this.props.modalSection.action}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
