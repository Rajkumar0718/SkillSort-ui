        ...
        return (
            <div ref={this.wrapperRef} className={this.state.sideBarClass} style={{ paddingLeft: "0px" }}>
                <div className="sidebar-menu" id="myDIV">
                    ...
                    <hr className='bottom-border' />
                    <Link to="/companyadmin" onClick={() => this.changeClass()}>
                        <div className="menu-icon focus">
                            <div className="row link">
                                <div className="col-3">
                                    <div data-tip data-for="result">
                                        <i style={{ fontSize: '1.3rem', color: '#3b489e' }} className="fa fa-building-o" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div className="col-9 menu-name">
                                    <span>Company</span>
                    ...
                    <Link to="/companyadmin/admin" onClick={() => this.changeClass()}>
                        <div className="menu-icon">
                            <div className="row link">
                                <div className="col-3">
                                    <div data-tip data-for="result">
