...
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='number' label='SSLC%' name='sslcPercentage' maxLength="5" min={1} max={5} onChange={(e) => this.handleChange(e, 'sslc')} value={this.state.competitor?.sslc} id='SSLC' aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
//                       <label className="form-label text-label" for="form12">Last Name</label>
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='name' label='Last Name' name='lastName' maxLength="50" value={this.state.competitor?.lastName} onChange={(e) => this.handleChange(e, 'lastName')} id='lastName' aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
...
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='number' label='HSC %' name='hscPercentage' maxLength="5" min={1} max={5} onChange={(e) => this.handleChange(e, 'hsc')} value={this.state.competitor?.hsc} id='hscPercentage' aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
...
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='email' label='Email' name='email' maxLength="50" onChange={(e) => this.handleChange(e, 'email')} value={this.state.competitor?.email} id='email' aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
...
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='number' label='UG%' name='ugPercentage' maxLength="5" min={1} max={5} onChange={(e) => this.handleChange(e, 'ug')} value={this.state.competitor?.ug} id='ugPercentage' aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
...
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='name' label='Phone' name='phone' maxLength="10" value={this.state.competitor?.phone} onChange={(e) => this.handleChange(e, 'phone')} id='phone' aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
...
//                     </div>
//                     <div className="col-4 competitor-input">
//                       <input className="profile-page" type='text' label='College Name' name='college' maxLength="50" onChange={(e) => this.handleChange(e, 'collegeName')} id='college' value={this.state.competitor?.collegeName} aria-label="default input example" /><span className='required'></span>
//                     </div>
//                     <div className="col-2 competitor-input" style={{ height: '3rem' }}>
...
//                           maxDate={moment().add(1, 'years').format('YYYY')}
...
//                       <input type="file" className="custom-file-input" onChange={(e) => this.onFileChange(e)} accept={"application/pdf"} style={{ width: '311px', marginLeft: '5px' }} defaultValue={this.state.resume} />
//                       <label className="custom-file-label text-label" style={{ width: '255px', marginLeft: '14px' }}>{this.state.resume ? this.state.resume?.name : "Upload Resume"}</label>
//                     </div>
...
//                     <input className="profile-page" type='email' label='Email' name='email' maxLength="50" value={this.state.competitor?.email} id='email' aria-label="default input example" /><span className='required'></span>
//                   </div>
//                 </div>
//                 <div className="row">
//                   <div className="col-6 competitor-login" style={{ height: '3rem' }}>
...
//             </div>
//           </div>
//           <Stepper activeStep={this.state.activeStep} alternativeLabel style={{ width: '100%', paddingBottom: '0' }}>
